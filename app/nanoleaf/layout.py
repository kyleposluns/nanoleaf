...
class PanelLayout(AuroraObject):
    ...
    def orientation(self):
        ...
        return self.__requester.request(method="GET", endpoint="panelLayout/globalOrientation/value")

    @property
    def orientation_min(self):
        """Returns the minimum orientation possible. (This always returns 0)"""
        return self.__requester.request(method="GET", endpoint="panelLayout/globalOrientation/min")

    @property
    def orientation_max(self):
        """Returns the maximum orientation possible. (This always returns 360)"""
        return self.__requester.request(method="GET", endpoint="panelLayout/globalOrientation/max")

    @property
    def panel_count(self):
        """Returns the number of panels connected to the device"""
        count = int(self.__requester.request(method="GET", endpoint="panelLayout/layout/numPanels"))
    ...
    def panel_length(self):
        ...
        return self.__requester.request(method="GET", endpoint="panelLayout/layout/sideLength")
    ...
    def panel_positions(self):
        ...
        """
        return self.__requester.request(method="GET", endpoint="panelLayout/layout/positionData")